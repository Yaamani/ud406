...
public class FileLoading extends ApplicationAdapter {
    ...
    public void create() {
        ...
        FileHandle punchlineFile = Gdx.files.internal("android/assets/punchline");

        // TODO: Read the file using FileHandle.readString()
        String punchlineString = punchlineFile.readString();

        // TODO: Decrypt the punchline
        String decrypted = decrypt(punchlineString);

        // TODO: Log the rest of the joke
        Gdx.app.log(TAG, "" + decrypted);
    }
